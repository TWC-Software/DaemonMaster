...
namespace DaemonMaster.Win32.PInvoke
{
    public static class Win32ErrorCodes
    {
        public static string GetErrorNameInt(int result)
        {
            return GetErrorNameUInt((uint) result);
        }

        public static string GetErrorNameUInt(uint result)
        {
            FieldInfo[] fields = typeof(Win32ErrorCodes).GetFields();
