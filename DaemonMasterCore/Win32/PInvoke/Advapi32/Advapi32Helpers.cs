...
namespace DaemonMasterCore.Win32.PInvoke.Advapi32
{
    public static partial class Advapi32
    {
        ...
        internal static StringBuilder ConvertDependenciesArraysToDoubleNullTerminatedString(string[] stringServiceDependencies, string[] stringGroupDependencies)
        {
        ...
        internal static LsaUnicodeString ToLsaString(this string s)
        {
