...
namespace DaemonMasterCore.Win32
{
    ...
    public class ServiceCredentials
    {
        ...
        /// </summary>
        public static ServiceCredentials LocalSystem = new ServiceCredentials(username: @"NT AUTHORITY\System", password: null);
        ...
        /// </summary>
        public static ServiceCredentials LocalService = new ServiceCredentials(username: @"NT AUTHORITY\LocalService", password: null);
        ...
        /// </summary>
        public static ServiceCredentials NetworkService = new ServiceCredentials(username: @"NT AUTHORITY\NetworkService", password: null);
